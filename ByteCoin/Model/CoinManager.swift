...
struct CoinManager {
    ...
    let apiKey = "A026451D-1507-4F78-9399-11E8D37D3168"
    
    let currencyArray = ["AUD", "BRL","CAD","CNY","EUR","GBP","CZK", "HKD","IDR","ILS","INR","JPY","MXN","NOK","NZD","PLN","RON","RUB","SEK","SGD","USD","ZAR"]
